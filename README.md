...
### Schema Design & Generation
    ...
    **Step 1**
    ...
    - Implement indexes for query optimization, specifically for the appointment table which will be frequently queried for availability using `start_time`, `anticipated_time`, `bay_id`, and `technician_id`.
    ...
    **Step 2(Validation & Refactoring)**
    ...
    The prompt I use for refactoring:
...
### SQL Query Implementation
    ...
    Firstly, I provided the table structures to the AI to establish context and requested the generation of CRUD operations. Prompt:
    ...
    **In English**
    ...
    - Generate queries to perform the following operations:
        ...
        .....
        other thing needed for business logic.
...
### Code Golang
    ...
    Firstly, To ensure the AI understood the project's Clean Architecture, I structured the core organization and the execution flow for the Dealership module as a reference. Then, I give those context for AI coding tool to learn it. Prompt:
    ...
    After that, I'm provide context which is a SQL query file for AI coding tool with prompt: "Proceed to implement the 6 corresponding routes for these queries in skill_module.go"
