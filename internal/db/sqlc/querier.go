...
type Querier interface {
	...
	GetServiceBayByID(ctx context.Context, id int32) (ServiceBay, error)
	...
	ListServiceBays(ctx context.Context) ([]ServiceBay, error)
	ListServiceBaysByDealershipID(ctx context.Context, dealershipID int32) ([]ServiceBay, error)
	ListServiceBaysByDealershipIDAndTypeID(ctx context.Context, arg ListServiceBaysByDealershipIDAndTypeIDParams) ([]ServiceBay, error)
	ListServiceBaysByTypeID(ctx context.Context, bayTypeID int32) ([]ServiceBay, error)
	...
	SearchServiceBaysByName(ctx context.Context, dollar_1 *string) ([]ServiceBay, error)
	SearchServiceBaysByNameAndDealershipID(ctx context.Context, arg SearchServiceBaysByNameAndDealershipIDParams) ([]ServiceBay, error)
	SearchServiceBaysByNameAndTypeID(ctx context.Context, arg SearchServiceBaysByNameAndTypeIDParams) ([]ServiceBay, error)
	SearchServiceBaysByNameDealershipIDAndTypeID(ctx context.Context, arg SearchServiceBaysByNameDealershipIDAndTypeIDParams) ([]ServiceBay, error)
